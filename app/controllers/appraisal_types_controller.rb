...
def create
  ...
  respond_to do |format|
    if @appraisal_type.save
      format.html { redirect_to appraisal_type_url(@appraisal_type), notice: "appraisal_type was successfully created." }
...
def update
  respond_to do |format|
    if @appraisal_type.update(appraisal_type_params)
      format.html { redirect_to appraisal_type_url(@appraisal_type), notice: "appraisal_type was successfully updated." }
...
def destroy
  ...
  respond_to do |format|
    format.html { redirect_to appraisal_types_url, notice: "appraisal_type was successfully destroyed." }
...
private
  ...
  def appraisal_type_params
    params.require(:appraisal_type).permit(:name, :description, :updated_by)
  end
end
